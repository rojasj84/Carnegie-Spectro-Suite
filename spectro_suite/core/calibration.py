"""
Optical Calibration and Coordinate Conversion for Universal Spectrometers.
"""
...
class OpticalCalibration:
    ...
    for multi-vendor monochromators and multichannel array detectors (CCDs).
    """
    ...
    def get_pixel_wavelengths(
        ...
        Pixels are 1-indexed (1 to N) matching standard dispersion geometry.
        """
    ...
    def convert_wavelengths_to_units(
        ...
        if unit == Units.NM:
            ...
            # Absolute energy in meV: 1239.7 / lambda * 1000

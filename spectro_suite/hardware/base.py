"""
Shared hardware interfaces: Protocol classes for vendor-agnostic spectrometers and detectors.
"""
...
class Spectrometer(Protocol):
    """Interface satisfied by any monochromator / spectrograph driver (Acton, Horiba, etc.)."""
...
class Camera(Protocol):
    """Interface satisfied by any optical detector / camera driver (Mock, PI-MTE, WinSpec, etc.)."""

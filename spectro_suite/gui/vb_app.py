...
try:
    ...
    from spectro_suite.core.filters import remove_cosmic_rays_threshold, remove_cosmic_rays_median
    from spectro_suite.core.stitcher import SpectrumStitcher, StitchInterval

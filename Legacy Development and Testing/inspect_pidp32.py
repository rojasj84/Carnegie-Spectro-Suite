...
dll_path = r"C:\Users\LabUserR129\Desktop\WinSpec32_Full\PIDP32.dll"
...
print(f"Total Exports in PIDP32.dll ({len(data):,} bytes): {num_names}")
for n in range(min(50, num_names)):

     ...
     If PlotAxis Then
        ...
        ' Clear the mess outside the axis frame
             ...
             If Dest Is Printer Then
                 ...
                 TopRect.Bottom = (Dest.Height / 10) / Printer.TwipsPerPixelY / PScaleY - 1
             ...
             If Dest Is Printer Then
                 ...
                 BotRect.Top = (Dest.Height / 10) * 9 / Printer.TwipsPerPixelY / PScaleY
             ...
             If Dest Is Printer Then
                 ...
                 LeftRect.Right = (Dest.Width / 10) / Printer.TwipsPerPixelX / PScaleX - 1
                 LeftRect.Bottom = Dest.Height / Printer.TwipsPerPixelY / PScaleY
                 Debug.Print LeftRect.Left, LeftRect.Right
                
             Else
                 LeftRect.Right = (Dest.Width / 10) / Screen.TwipsPerPixelX - 1
             ...
             RightRect.Top = 0
             If Dest Is Printer Then
                 RightRect.Left = (Dest.Width / 10) * 9 / Printer.TwipsPerPixelX / PScaleX
             ...
             Else
                 RightRect.Left = (Dest.Width / 10) * 9 / Screen.TwipsPerPixelX
            ...
            While klbl < 8
               If StartY < MaxY Then
                 ...
                 If Dest Is Printer Then
                    ...
                    Dest.CurrentY = MaxY - StartY - StepY / 8
                 Else
                    Dest.Line (MinX, StartY)-(MinX - (MaxX - MinX) / 100, StartY)
                    Dest.CurrentX = MinX - (MaxX - MinX) / 8
                    Dest.CurrentY = StartY + StepY / 8
                 End If

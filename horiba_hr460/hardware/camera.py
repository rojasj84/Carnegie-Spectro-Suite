"""
Universal Camera & Detector Hardware Abstraction.
=================================================
Provides baseline detector interfaces and simulated detector implementations
for development, testing, and multi-vendor camera integrations (e.g. Thorlabs,
Andor, Hamamatsu, FLIR, or custom spectrometers).
"""
...
class MockCamera:
    ...
    without physical detector hardware.
    ...
    def grab_2d_frame(self, color_mode: str = "RGB", timeout_ms: int = 2000) -> Optional[np.ndarray]:
        """Grab a 2D frame from the simulated detector."""

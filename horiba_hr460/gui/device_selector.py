...
class DeviceSelectorDialog:
    ...
    def __init__(
        ...
        self.result_action: str = "CANCEL" # "LAUNCH", "DEMO", "CANCEL"
    ...
    def _apply_initial_selection(self, config: Optional[SpectrometerConfig] = None):
        ...
        if config:
            ...
            # Find matching profile name if any
            ...
            # Default to Acton SP2150 if available, else first
    ...
    def _display_scan_results(self, devices: list[dict]):
        ...
        # Clear existing detected widgets
    ...
    def show(self) -> Tuple[str, Optional[SpectrometerConfig], bool]:
        ...
        Returns:
            Tuple of (action: str, config: Optional[SpectrometerConfig], force_mock: bool)
            where action is "LAUNCH", "DEMO", or "CANCEL".
        """
        if self.is_standalone:
            self.root.mainloop()
        else:
